...
def how_many_max_values_parallel(ar,maxValue):
...
if __name__ == '__main__':
    ...
    for i in range(2): 
        ...
        process = multiprocessing.Process(target=how_many_max_values_parallel,args = (ar[paso:paso1],max(ar)))
        process.start()
        process.join()
        paso = paso1
        paso1 = paso1+20000000
        #print(ret.value)
